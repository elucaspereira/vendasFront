...
ItemModel geladeira = ItemModel(
  ...
  imgUrl: 'eletronicos/geladeira.png',
  price: 5658.98,
  unit: 'UN',
);
...
ItemModel placaMae = ItemModel(
  ...
  imgUrl: 'eletronicos/placa_mae.png',
  price: 855.60,
  unit: 'PC',
);
ItemModel mousePad = ItemModel(
  ...
  imgUrl: 'eletronicos/mousepad.png',
  price: 90.00,
  unit: 'UN',
);
